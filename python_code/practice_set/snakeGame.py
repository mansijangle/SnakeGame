...
# Background Image
bgimg = pygame.image.load("C:\python_code\images\space.jpg")
bgimg = pygame.transform.scale(
    bgimg, (screen_width, screen_height)).convert_alpha()


# Game Title
pygame.display.set_caption("Snake Game By Mansi")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    pygame.mixer.music.load('C:/Users/Hp/Downloads/Doraemon-Title-Song.mp3')
